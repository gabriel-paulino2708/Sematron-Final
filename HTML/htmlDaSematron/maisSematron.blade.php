    ...
    <body class="Corpo">
        ...
        <header>
            ...
            <div class="Parte-De-Cima">
                ...
                <div class="Links">
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/inicio.blade.php')}}">Página Inicial</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/inscricoes.blade.php')}}">Inscrições</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/minicursos.blade.php')}}">Minicursos</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/visitas.blade.php')}}">Visitas</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/login.blade.php')}}">Login</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/cadastro.blade.php')}}">Cadastro</a>
                    <a class="Link-Do-Topo" href="{{asset('/htmlDaSematron/maisSematron.blade.php')}}">Mais Sematron</a>
                    <a class="Link-Do-Topo Direita" href="{{asset('/htmlDaSematron/contato.blade.php')}}">Contato</a>
                </div>
            </div>
        </header>
